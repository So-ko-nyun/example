                    ...
                    if date_check_tag:
                        ...
                        try:
                            ...
                            if is_within_date_range(post_date,start_date,end_date):
                                posts_urls.append({'url': href, "id": post_id, 'date': post_date})
...
path = '/Users/chujiu/Coding/DataCrawling/BeautifulSouppp/for_ProductNews/test_PN'
filename = 'test_PN_1.json'
