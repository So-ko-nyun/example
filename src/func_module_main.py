...
def startCrawls(baseUrl, start_date_str, end_date_str, serverUrl):
    ...
    for post in posts_urls:
        print("-----------------------------------------")
        print("각 게시글의 상세내역을 크롤링합니다. 현재 페이지는: ", i ,"번째 페이지입니다."," \n\n\n")
        ...
        print("각 게시글의 상세내역 크롤링이 끝났습니다. 끝난 페이지는",i,"번째 페이지입니다.")
        print("---------------------------------------------------------\n\n\n")
        i+=1
                    ...
                    if date_check_tag:
                        ...
                        try:
                            ...
                            if is_within_date_range(post_date,start_date,end_date):
                                posts_urls.append({'url': href, "id": post_id, 'date': post_date, 'title': title, 'type': post_type})
